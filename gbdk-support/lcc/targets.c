...
arg_entry llist0_defaults_nes[] = {
    ...
    {.searchkey = "CODE=",        .addflag = "-b",.addvalue = "CODE=0x07C400",      .found = false},
    {.searchkey= "RODATA=",      .addflag= "-b",.addvalue= "RODATA=0x07C000",       .found= false},
    {.searchkey = "_CODE_1=",     .addflag = "-b",.addvalue = "_CODE_1=0x018000",   .found = false},
    //{.searchkey = "_CODE_2=",     .addflag = "-b",.addvalue = "_CODE_2=0x028000",   .found = false},
    //{.searchkey = "_CODE_3=",     .addflag = "-b",.addvalue = "_CODE_3=0x038000",   .found = false},
    {.searchkey= "CRT0CODE=",    .addflag= "-b",.addvalue= "CRT0CODE=0x07F800",     .found= false},
    {.searchkey= "VECTORS=",     .addflag= "-b",.addvalue= "VECTORS=0x07F800",      .found= false},
