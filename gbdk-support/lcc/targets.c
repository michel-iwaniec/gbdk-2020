...
// NES
// -b CODE=0x8000 -b RODATA=0xC000 -b _CODE=0xD000 -b _CODE_3=0xF000 -b _CODE_1=0xE000 -b CRT0CODE=0xF800 -b VECTORS=0xFFFA -b BSS=0x400 -b DATA=0xF0 -b ZP=0x40 
arg_entry llist0_defaults_nes[] = {
    //{.searchkey= "_DATA=",       .addflag= "-b",.addvalue= "_DATA=0x8000",       .found= false},
    //{.searchkey= "_CODE=",       .addflag= "-b",.addvalue= "_CODE=0xD000",       .found= false},
    {.searchkey= "CODE=",        .addflag= "-b",.addvalue= "CODE=0x8000",        .found= false},
    {.searchkey= "RODATA=",      .addflag= "-b",.addvalue= "RODATA=0xC000",      .found= false},
    {.searchkey= "_CODE_1=",     .addflag= "-b",.addvalue= "_CODE_1=0xE000",     .found= false},
    {.searchkey= "_CODE_3=",     .addflag= "-b",.addvalue= "_CODE_3=0xF000",     .found= false},
    {.searchkey= "CRT0CODE=",    .addflag= "-b",.addvalue= "CRT0CODE=0xF800",    .found= false},
    {.searchkey= "VECTORS=",     .addflag= "-b",.addvalue= "VECTORS=0xF800",     .found= false},
    {.searchkey= "BSS=",         .addflag= "-b",.addvalue= "BSS=0x400",          .found= false},
    //{.searchkey = "BSS=",         .addflag = "-b",.addvalue = "BSS=0x200",          .found = false},
    {.searchkey= "DATA=",        .addflag= "-b",.addvalue= "DATA=0xF0",          .found= false},
    //{.searchkey= "ZP=",          .addflag= "-b",.addvalue= "ZP=0x40",            .found= false},
